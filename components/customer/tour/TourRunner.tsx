    ...
    async (steps: ExtendedDriveStep[], fromStep = 0) => {
      ...
      const driverObj = driver({
        ...
        onPopoverRender: (popover) => {
          popover.wrapper.classList.add("!rounded-xl", "!border", "!border-border", "!shadow-xl", "dark:!bg-card");
          popover.title.classList.add("!text-lg", "!font-semibold", "!text-foreground");
          popover.description.classList.add("!text-sm", "!text-muted-foreground", "!mt-2");
          ...
          if (popover.nextButton) {
            popover.nextButton.classList.add(
              ...
              "!px-4", "!py-2", "!text-sm", "!font-medium", "!rounded-md",
              "hover:!bg-primary/90", "transition-colors", "!shadow-sm", "!ml-2"
            );
          }
